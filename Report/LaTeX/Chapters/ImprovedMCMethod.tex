...
The difference between this and the for loop for the brute force Monte Carlo method given in \fxnote{ref to sec}, is the definition of the random variables and explicit statement of the total PDF $px$.
\begin{lstlisting}
for (int i=0;i<N;i++){
	for (int j=0;j<6;j++){
