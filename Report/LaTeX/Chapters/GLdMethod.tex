...
In this project, we \fxnote{sorry about the "we"} have accepted that $10^{-6}$ is close enough to zero to neglect contributions from the part of the wave function when the wave function gives a value of this order.
